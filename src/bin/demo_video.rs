...
fn main() {
    ...
    println!("   Running: ffmpeg -framerate 30 -i demo_frames/frame_%04d.png -c:v libx264 -pix_fmt yuv420p -y demo.mp4");
    
    let output = std::process::Command::new("ffmpeg")
        .args(&[
            "-framerate", "30",
            "-i", "demo_frames/frame_%04d.png",
            "-c:v", "libx264",
            "-crf", "28",
            "-pix_fmt", "yuv420p",
            "-y",
    ...
    match output {
        ...
        Ok(output) => {
            ...
            println!("   ffmpeg -framerate 30 -i demo_frames/frame_%04d.png -c:v libx264 -pix_fmt yuv420p -y demo.mp4");
        }
        Err(e) => {
